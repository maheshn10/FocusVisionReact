const API_URL = 'https://pha-apps-eu.novartis.net/Origin/api/';
const ANALYSIS_PATH = '/';
const prodConfig = {
  ...
  serverUrl: 'https://spotfprd.dev.pharma.novartis.intra/spotfire/wp',
  ...
  LOGURL: 'https://share.novartis.net/sites/Origin/_api/SP.UserProfiles.PeopleManager/GetMyProperties?$select=DisplayName,AccountName',
  BOREPORTURL: 'https://bop.eu.novartis.net:8443/BOE/OpenDocument/opendoc/',
  SFURL: 'https://spotfprd.dev.pharma.novartis.intra/spotfire/wp',
  ANALYSISPATHPREFIX: ANALYSIS_PATH,
  IMAGEURL: 'https://pha-apps-eu.novartis.net/cdn/Origin/images/',
