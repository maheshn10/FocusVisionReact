const API_URL = 'https://pha-apps-qa-eu.novartis.net/Origin/api/';
const ANALYSIS_PATH = '/TEST/';
const qaConfig = {
  ...
  serverUrl: 'https://spotftst.dev.pharma.novartis.intra/spotfire/wp',
  ...
  LOGURL: 'https://share.novartis.net/sites/Origin-QA/_api/SP.UserProfiles.PeopleManager/GetMyProperties?$select=DisplayName,AccountName',
  BOREPORTURL: 'https://boq.eu.novartis.net:8443/BOE/OpenDocument/opendoc/',
  SFURL: 'https://spotftst.dev.pharma.novartis.intra/spotfire/wp',
  ANALYSISPATHPREFIX: ANALYSIS_PATH,
  IMAGEURL: 'https://pha-apps-qa-eu.novartis.net/cdn/Origin/images/',
